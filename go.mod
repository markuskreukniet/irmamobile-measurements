...
require (
	...
	github.com/markuskreukniet/irmago-measurements v0.0.1
...
replace github.com/markuskreukniet/irmago-measurements => /home/markus/go/src/github.com/markuskreukniet/irmago-measurements
